...
public class HomePage extends BaseClassPW {
	...
	//constructor
	public HomePage(Page page,Page productpage) {
		this.page=page;
...
//		new page(product page)
		this.addToCart=productpage.locator("#add-to-cart-button");
		this.addedToCartMsg=productpage.locator("//span[text()[normalize-space()='Added to Cart']]");
...
//	private String addedToCartMsg ="//span[text()[normalize-space()='Added to Cart']]";
	...
	public void productAddToCart() {
		...
		productpage = page.waitForPopup(()->{
			btnClick(product);	
		});
		
		btnClick(addToCart);
		CheckText(addedToCartMsg, "Added to Cart");
	}
